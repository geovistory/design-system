...
| `classUriPrefix`    | `class-uri-prefix`    | classUriPrefix Optional prefix for the class uris. Example: "http://geovistory.org/resource/" Default: "http://geovistory.org/resource/"                                                                                                                                          | `string`   | `undefined` |
...
| `preferredItems`    | --                    | preferredItems List of preferred items. If set, these items will be shown first in the list of items.  Example: ["c523", "c50"]                                                                                                                                                   | `string[]` | `undefined` |
