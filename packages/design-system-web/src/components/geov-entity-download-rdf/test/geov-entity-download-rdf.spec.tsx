  ...
  it('Client side: fetches data and renders', async () => {
    ...
    <geov-entity-download-rdf button-icon="download-outline" button-label="Download RDF" color="primary" entityid="i785518" expand="block" fill="outline">
      <ion-button expand="block" fill="outline" color="primary">
        Download RDF <ion-icon icon="download-outline"></ion-icon>
      </ion-button>
      <ion-modal>
        <ion-header>
          <ion-toolbar>
        ...
        <ion-content class="ion-padding">
          <ion-list lines="none">
            <ion-item button="" download="Download">
              <ion-icon slot="start" icon="download-outline"></ion-icon>
    ...
    expect(rendered.html).toEqualHtml(`
        ...
        <body><geov-entity-download-rdf entity-id="i785518" color="primary" expand="block" fill="outline"
                button-label="Download RDF" button-icon="download-outline" class="hydrated" s-id="1"><!--r.1--><ion-button expand="block" fill="outline" color="primary"
                    c-id="1.0.0.0"><!--t.1.1.1.0-->Download RDF <ion-icon icon="download-outline"
                        ...
                        class="ion-padding" c-id="1.11.1.1"><ion-list lines="none" c-id="1.12.2.0"><ion-item button=""
                                download="Download" c-id="1.13.3.0"><ion-icon slot="start" icon="download-outline"
  ...
  it('Client side: fetches data and hydrates prerendered html', async () => {
    ...
    expect(page.root).toEqualHtml(
      ...
      button-icon="download-outline" class="hydrated"><!--r.1--><ion-button id="open-custom-dialog" expand="block"
          fill="outline" color="primary">Download RDF <ion-icon icon="download-outline"></ion-icon></ion-button><ion-modal
          id="example-modal" trigger="open-custom-dialog"><ion-header><ion-toolbar><ion-buttons
                  ...
                  lines="none"><ion-item button="" download="Download"><ion-icon slot="start"
                          icon="download-outline"></ion-icon><ion-label>RDF XML</ion-label></ion-item><ion-item button=""
                      download="Download"><ion-icon slot="start"
                          icon="download-outline"></ion-icon><ion-label>JSON-LD</ion-label></ion-item><ion-item button=""
                      download="Download"><ion-icon slot="start"
                          icon="download-outline"></ion-icon><ion-label>N-Triples</ion-label></ion-item><ion-item
                      button="" download="Download"><ion-icon slot="start"
                          icon="download-outline"></ion-icon><ion-label>N-Quads</ion-label></ion-item><ion-item button=""
                      download="Download"><ion-icon slot="start"
                          icon="download-outline"></ion-icon><ion-label>TRIX</ion-label></ion-item><ion-item button=""
                      download="Download"><ion-icon slot="start"
                          icon="download-outline"></ion-icon><ion-label>Thrift</ion-label></ion-item><ion-item button=""
                      download="Download"><ion-icon slot="start"
                          icon="download-outline"></ion-icon><ion-label>Turtle</ion-label></ion-item></ion-list></ion-content></ion-modal><!--s.1.41.0.2.--></geov-entity-download-rdf>`,
    );
  });
});
