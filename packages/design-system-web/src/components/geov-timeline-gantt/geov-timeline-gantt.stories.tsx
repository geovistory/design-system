...
type timespanData = {
  ...
  entityLink: { type: 'uri'; value: string };
...
const ts1: timespanData = {
  ...
  entityLink: { type: 'uri', value: 'https://example.com/entity1' },
...
const ts2: timespanData = {
  ...
  entityLink: { type: 'uri', value: 'https://example.com/entity2' },
...
const ts3: timespanData = {
  ...
  entityLink: { type: 'uri', value: 'https://example.com/entity3' },
...
const ts3bis: timespanData = {
  ...
  entityClassLabel: { type: 'literal', value: 'Live' },
  entityLink: { type: 'uri', value: 'https://example.com/entity4' },
...
const ts4: timespanData = {
  ...
  entityClassLabel: { type: 'literal', value: 'Live' },
  entityLink: { type: 'uri', value: 'https://example.com/entity5' },
...
const ts5: timespanData = {
  ...
  entityClassLabel: { type: 'literal', value: 'Live' },
  entityLink: { type: 'uri', value: 'https://example.com/entity' },
...
const ts6: timespanData = {
  ...
  entityClassLabel: { type: 'literal', value: 'Live' },
  entityLink: { type: 'uri', value: 'https://example.com/entity6' },
...
const ts7: timespanData = {
  ...
  entityClassLabel: { type: 'literal', value: 'Live' },
  entityLink: { type: 'uri', value: 'https://example.com/entity7' },
...
export const colors = await stencilWrapper(
  ...
  .customBg {
    ...
    --ion-toolbar-background: aliceblue;
  }
`}</style>
