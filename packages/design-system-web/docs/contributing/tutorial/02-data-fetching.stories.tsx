...
import { IonApp, IonContent, IonGrid, IonIcon } from '../../../.storybook/stencil-generated/component';
  ...
  <IonApp>
    <IonContent class="ion-padding">
      <IonGrid fixed>
        ...
        <p>
          Prerequisite: Successful <a href="/?path=/story/contributing-tutorial-hello-world--hello-world">Hello World</a>.
        </p>
        <h4>The Query</h4>
        <p>
        ...
        <SyntaxHighlighter style={prism} language="sparql">
          {q1}
        </SyntaxHighlighter>
        <p>
        ...
        <SyntaxHighlighter style={prism} language="json">
          {r1}
        </SyntaxHighlighter>
        <h4>The Challenge</h4>
        ...
        <SyntaxHighlighter style={prism} language="typescript">
          {c1}
        </SyntaxHighlighter>
