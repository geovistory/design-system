    ...
    <IonApp>
      <IonContent class="ion-padding">
        <IonGrid fixed>
          ...
          <h3>Texts</h3>
          <p>
            The maximum width of headers and paragraphs is 38rem. This limits the maximum number of characters per line to ~76 characters for texts with font size 1rem, even on
            large screens.
          </p>
          <p>
            <SyntaxHighlighter language="css">{css1}</SyntaxHighlighter>
          </p>
